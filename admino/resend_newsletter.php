    ...
    <div id="container">
        ...
        <div class="inner_body_2" style="margin-left: 10%;width: 80%;">
            <div class="left_inner_body_2">
                ...
                if(isset($_GET['id'])){
                    $id = $_GET['id'];
                    $query = "select * from sent_newsletter where id = '{$id}' limit 1";
                    $result = mysql_query($query);

                    $after_result = mysql_fetch_array($result);
                    $title = $after_result['title'];
                    $message = $after_result['message'];
                    $date = $after_result['date'];
                    $recipents = $after_result['recipents'];
                }else{
                    redirect_to("newsletter.php");
                }
                ?>
                <form method="post" name="alumni_reg" action="in/resend_newsletter.php?id=<?php echo $id; ?>">
                    <div class="form_box">
                        ...
                        <span class="form_box_column_input">
                            <input name="Title" type="text" value="<?php echo $title; ?>" class="form_box_input_2_1" placeholder="Your Title." required>
                        </span>
                        </div>
                        <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            <textarea name="Message" value="<?php echo $message; ?>" class="form_box_input_text_area" placeholder="Your Message" required></textarea>
                        </span>
                        </div>
                        <div class="form_box_row">
                            <input name="Submit" type="submit" class="newsletter_submit_button" value="Resend" style="border-radius: 3px;margin-left: 192px;" >
                        </div>
                    </div>
                </form>
