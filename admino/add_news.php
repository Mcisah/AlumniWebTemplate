...
<section id="wrapper">
    ...
    <div id="container">
        <div class="about_board" style="height: 200px;width: 80%;margin-left:10%;">
            <span class="about_board_header" style="text-align: left;">Add News</span>
        </div>
        <div class="inner_body_2" style="margin-left: 10%;width: 80%;">
            <div class="left_inner_body_2">
                <span class="news_container_column_header_2" style="margin-bottom: 20px;font-size: 14px;text-decoration: underline;">Add your news content to all fields as they are (all) required.</span>
                <form method="post" name="alumni_reg" action="in/add_news.php" enctype="multipart/form-data">
                    <div class="form_box">
                        ...
                        <span class="form_box_column_input">
                            <input name="Title" type="text" class="form_box_input_2_1" placeholder="Your News Title." required>
                        </span>
                        </div>
                        <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            <textarea name="Summary" class="form_box_input_text_area" placeholder="Your News Summary..." required></textarea>
                        </span>
                        </div>
                        <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            <input name="Cover" type="file" class="form_box_input_2_1" placeholder="Your Cover Image" required>
                        </span>
                        </div>
                        <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            <textarea name="Body" class="form_box_input_text_area" placeholder="Body of the news goes here ..." required></textarea>
                        </span>
                        </div>
                        <div class="form_box_row">
           ...
           frmvalidator.addValidation("Cover","req", "Please add the News Cover Image");
           frmvalidator.addValidation("Cover","req_file");
