...
<section id="wrapper">
    ...
    <div id="container">
        <div class="about_board" style="height: 200px;width: 80%;margin-left:10%;">
            <span class="about_board_header" style="text-align: left;">Add Event</span>
        </div>
        <div class="inner_body_2" style="margin-left: 10%;width: 80%;">
            <div class="left_inner_body_2">
                <span class="news_container_column_header_2" style="margin-bottom: 20px;font-size: 14px;text-decoration: underline;">Add your event content to all fields as they are (all) required.</span>
                <form method="post" name="alumni_reg" action="in/add_event.php">
                    <div class="form_box">
                        ...
                        <span class="form_box_column_input">
                            <input name="Title" type="text" class="form_box_input_2_1" placeholder="Your Event Title." required>
                        </span>
                        </div>
                        <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            <input name="Venue" type="text" class="form_box_input_2_1" placeholder="Your Event Venue" required>
                        </span>
                        </div>
                        <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            ...
                            <label>
                                <select name="Meridian" class="form_box_input_small" required>
                                    <option value="Meridian" selected>Meridian</option>
                                    <option>am</option>
                                    <option>pm</option>
                                </select>
                            </label>
