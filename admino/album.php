    ...
    <div id="container">
        <div class="about_board" style="width: 80%;margin-left: 10%;height: 200px;">
            <span class="about_board_header" style="text-align: left;">
                Your Albums
                <a href="add_album.php"><span class="add_button">Add Album +</span></a>
            </span>
        </div>
        <div class="inner_body_2" style="width: 80%;margin-left: 10%;">
            <div class="events_table_container">
                <span class="events_table_header">
                    ...
                    <span class="events_table_header_content" style="width: 35%;">Album Title</span>
                    <span class="events_table_header_content" style="width: 10%;">Date</span>
                    <span class="events_table_header_content" style="width: 15%;">Content</span>
                </span>
                <?php
                ...
                if(mysql_num_rows($result) > 0){
                    ...
                    <span class='events_table_header_content' style='width: 10%;'>{$date}</span>
                    <span class='events_table_header_content' style='width: 15%;'>{$no} picture(s)</span>
                    <a href='edit_album.php?id={$album_id}'><span class='events_table_header_content hoverline' style='width: 4%;'>Update</span></a>
                    <a href='in/del_album.php?id={$album_id}'><span class='events_table_header_content hoverline' style='width: 5%;'>Delete</span></a> 
                </span>";
                        }
                        $s_n++;
                    }
                }else{
                    echo "<div class='events_table_row'><div class='none_class'>You have not Added any Album!</div></div> ";
                }
