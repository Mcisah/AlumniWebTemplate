    ...
    <div id="container">
        ...
        <div class="inner_body_2" style="margin-left: 10%;width: 80%;">
            <div class="left_inner_body_2">
                <span class="news_container_column_header_2" style="margin-bottom: 20px;font-size: 14px;text-decoration: underline;">Add a new picture to an album by filling all fields as they are (all) required.</span>
                <form method="post" name="alumni_reg" action="in/add_picture.php" enctype="multipart/form-data">
                    <div class="form_box">
                        ...
                        <span class="form_box_column_input">
                            <input name="Title" type="text" style="width: 90%;height: 23px;" class="form_box_input_2_1" placeholder="Picture Label." required>
                        </span>
                            </div>
                            <div class="form_box_row">
                        ...
                        <span class="form_box_column_input">
                            <input name="Picture" type="file" class="form_box_input" placeholder="Your Picture Goes Here" required>
                        </span>
                        </div>
                        <div class="form_box_row">
           ...
           frmvalidator.addValidation("Picture","req", "Please add your Picture");
           frmvalidator.addValidation("Picture","req_file");
