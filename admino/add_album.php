    ...
    <div id="container">
        ...
        <div class="inner_body_2" style="margin-left: 10%;width: 80%;">
            <div class="left_inner_body_2">
                <span class="news_container_column_header_2" style="margin-bottom: 20px;font-size: 14px;text-decoration: underline;">Add your new album by filling all fields as they are (all) required.</span>
                <form method="post" name="alumni_reg" action="in/add_album.php">
                    <div class="form_box">
                        ...
                        <span class="form_box_column_input">
                            <input name="Album" type="text" class="form_box_input_2_1" placeholder="Album Title." required>
                        </span>
                        </div>
                        <div class="form_box_row">
