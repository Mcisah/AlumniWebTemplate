    ...
    <div id="container">
        ...
        <div class="inner_body_2" style="margin-left: 10%;width: 80%;">
            <div class="left_inner_body_2">
                <span class="news_container_column_header_2" style="margin-bottom: 20px;font-size: 14px;text-decoration: underline;">Update your album by filling all fields as they are (all) required.</span>
                <?php
                if(isset($_GET['id'])){
                    $id = $_GET['id'];
                ...
                ?>
                <form method="post" name="alumni_reg" action="in/edit_album.php?id=<?php echo $id; ?>">
                    <div class="form_box">
                        ...
                        <span class="form_box_column_input">
                            <input name="Album" value="<?php echo $name; ?>" type="text" class="form_box_input_2_1" placeholder="Album Title." required>
                        </span>
                        </div>
                        <div class="form_box_row">
           ...
           frmvalidator.addValidation("Album","req","Please enter your Album's Name");
