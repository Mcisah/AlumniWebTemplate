    ...
    <div id="container">
        ...
        <div class="inner_body_2" style="width: 80%;margin-left: 10%;">
            <div class="events_table_container">
                <span class="events_table_header" style="width: 61%;">
                    <span class="events_table_header_content" style="width: 25px;text-align: center;margin-right:0;">S/N</span>
                    <span class="events_table_header_content" style="width: 35%;">Subscriber's Email</span>
                </span>
                <?php
                ...
                if(mysql_num_rows($result) > 0){
                    while($set = mysql_fetch_array($result)) {
                        if (isset($set)) {
                            ...
                            echo "<span class=\"events_table_row\" style=\"width: 61%;\">
                    <span class=\"events_table_header_content\" style=\"width: 25px;text-align: center;margin-right:0;\">{$s_n}</span>
                    <span class=\"events_table_header_content\" style=\"width: 35%;\">{$headline}</span>
                    <a href='in/del_subscriber.php?id={$email_id}'><span class=\"events_table_header_content hoverline\" style=\"width: 9%;\">Delete</span></a> 
                </span>";
                        }
                        $s_n++;
                    }
